          ...
          <ScrollReveal>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <button 
                ...
                className="px-8 py-4 bg-black text-white rounded-full font-semibold transition-all duration-300 ease-in-out hover:bg-gray-800 hover:scale-105 hover:-translate-y-1 hover:shadow-2xl text-center shadow-lg shadow-black/10"
              >
                Get in Touch
              </button>
              <button 
                onClick={scrollToProjects}
                className="px-8 py-4 bg-white border border-gray-200 text-gray-900 rounded-full font-semibold transition-all duration-300 ease-in-out hover:border-gray-400 hover:scale-105 hover:-translate-y-1 hover:shadow-xl text-center"
              >
                View Projects
              </button>
            </div>
